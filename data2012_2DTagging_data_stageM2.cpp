...
//*****************************************************************************************************
	...
	hAlpha->Fill(alpha,miscevent_weight);
		...
		//if(gammapt>40. && DeltaPhi_j1gamma>2.8 && fabs(firstjeteta)<1.3 && (alpha<0.2 || secondjetpt<10)) {
		if(DeltaPhi_j1gamma>2.8 && fabs(firstjeteta)<1.3 && (alpha<0.2 || secondjetpt<10)) {			if(muonn==0){
				if(electronn==0) {
